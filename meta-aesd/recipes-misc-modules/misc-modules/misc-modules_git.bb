...
RDEPENDS:${PN}:remove = "kernel-module-faulty-${KERNEL_VERSION}"
RDEPENDS:${PN}:remove = "kernel-module-hello-${KERNEL_VERSION}"
RDEPENDS:${PN}:remove = "kernel-module-hello"
RDEPENDS:${PN}:remove = "kernel-module-faulty"
